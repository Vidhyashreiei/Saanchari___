...
with col1:
    st.markdown("""
        <div style='display: flex; align-items: center; padding: 0.5rem 0 0.2rem 0;'>
            <h1 class='main-title' style='margin: 0;'>🗺️ Saanchari</h1>
        </div>
    """, unsafe_allow_html=True)

with col2:
    st.markdown("<div style='display: flex; align-items: center; padding: 0.5rem 0 0.2rem 0; justify-content: flex-end;'>", unsafe_allow_html=True)
...
# Add border line with minimal margin
st.markdown("""
    <div style='border-bottom: 2px solid rgba(7, 84, 107, 0.1); margin-bottom: 0.5rem;'></div>
""", unsafe_allow_html=True)
...
# Quick Questions - Always visible but compact
st.markdown("<div style='text-align: center; margin: 0.5rem 0 1rem 0;'>", unsafe_allow_html=True)
st.markdown("<p style='color: #07546B; font-size: 1rem; font-weight: 600; margin-bottom: 0.5rem;'>🚀 Quick Start</p>", unsafe_allow_html=True)
...
SYSTEM_PROMPT = (
    ...
    "IMPORTANT: Always format your responses as bullet points or numbered lists. Never use long paragraphs. "
    "Use **bold formatting** for key points, place names, food items, and important information. "
    "Structure your responses with clear headings and bullet points. "
    "Make the text easy to scan and read quickly with short, concise bullet points."
)
...
# Footer at bottom of screen below chat typing box
st.markdown("""
    <div style='
        position: fixed; 
        bottom: 0; 
        ...
        color: #666; 
        font-size: 0.8rem; 
        border-top: 1px solid rgba(7, 84, 107, 0.1);
        z-index: 1000;
    '>
